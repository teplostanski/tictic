export declare type TDate = Date | string;
declare type TCommontDateTimeTypes = {
    /**
     * @default new Date()
     */
    date?: TDate;
...
export declare type TLetterCase = 'capitalize' | 'uppercase' | 'lowercase';
export declare type TGetDate = TCommontDateTimeTypes & {
    /**
     * @default 'YYYY-MM-DD'
     */
